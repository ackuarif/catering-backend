...
routes.delete("/deleteMenuIsi/:id", Auth.adminIsAuthenticated, MenuController.deleteMenuIsi);
routes.get("/getMenuIsiByMenuId/:menu_id", MenuController.getMenuIsiByMenuId);
routes.post("/addMenuGambar", [Auth.adminIsAuthenticated, multer.single("gambar")], MenuController.addMenuGambar);
routes.delete("/deleteMenuGambar/:id", Auth.adminIsAuthenticated, MenuController.deleteMenuGambar);
